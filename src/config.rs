...
pub const INITIAL_BALL_MOVEMENT_X: f32 = -400.0;
pub const INITIAL_BALL_MOVEMENT_Y: f32 = -0.0;
pub const BALL_RADIUS: f32 = 40.0;

pub const PAD_SIZE_X: f32 = SCREEN_WIDTH/32.0;
pub const PAD_SIZE_Y: f32 = SCREEN_WIDTH/32.0;
...
pub const BALL_COLLISION_SPEED_INCREMENT: f32 = 50.0;
